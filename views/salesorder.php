		...
		<table id="myTable" style="font-size:13px;width:1500px;">
			<thead>
				<tr onClick=""  class="border_black">
                    ...
                    <th style="width: 8%;">Cust CP</th>
                    <th style="width: 10%;">Cust PO</th>
                    ...
                    <th style="width: 6%;">Tanggal Kirim</th>
...
$(document).ready(function(){
	...
	function detail(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>tsod/'+param+'.html',function(data){
			$('#tester').html(data);
		});
	}
	...
	function add(){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>addtsoh.html',function(data){
			$('#tester').html(data);
		});
	}
    </script>