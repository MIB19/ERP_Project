		...
		<table id="myTable" style="font-size:13px;width:1500px;">
			<thead>
				<tr onClick=""  class="border_black">
                    ...
                    <th style="width: 7%;">Warna</th>
                    <th style="width: 8%;">Tipe</th>
                    <th style="width: 6%;">Tahun</th>
                    <th style="width: 7%;">No BPKB</th>
                    <th style="width: 7%;">No TNKB</th>
                    <th style="width: 8%;">Tgl BPKB</th>
                    <th style="width: 8%;">Tgl TNKB</th>
...
$(document).ready(function(){
	...
	function add(){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>addmarmd.html',function(data){
			$('#tester').html(data);
		});
	}
    </script>