...
$(document).ready(function(){
	...
	function update(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>selectmwarn/'+param+'.html',function(data){
			$('#tester').html(data);
		});
	}
	function aktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>aktifmwrn/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>mbrg/1.html',function(data){
				$('#tester').html(data);
			});
		});
	}
	function nonaktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>nonaktifmwrn/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>mbrg/1.html',function(data){
				$('#tester').html(data);
			});
		});
	...
	function action_delete(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>hapusmwrn/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>mbrg/1.html',function(data){
				$('#tester').html(data);
			});
		});
