<div class="form_erp">
	<div class="form_erp_top">Edit COA</div>
    ...
    <div class="container">
        <form action="<?php echo $config->base_url();?>updatemcoa.html" class="" method="post">
            <input type="hidden" name="no" value="<?= $mcoa['no']; ?>" required>
            ...
            <div style="margin-top: 20px;">
                ...
                <div class="alas_luar">
                    ...
                    <?php foreach( $prsh as $row1 ) : ?> 
                        <option value="<?= $row1['no'] ?>" <?php if($mcoa['mprsh']==$row1['no']) echo 'selected="selected"'; ?>><?= $row1['nama'] ?></option>
                    <?php endforeach ?>
                    </select>
                </div>
            </div>
            <div style="margin-top: 20px;">
                ...
                <div class="alas_luar">
                    ...
                    <?php foreach( $mcab as $row ) : ?> 
                        <option value="<?= $row['no'] ?>" <?php if($mcoa['mcab']==$row['no']) echo 'selected="selected"'; ?>><?= $row['nama'] ?></option>
                    <?php endforeach ?>
                    </select>
                </div>
            </div>
            <div style="margin-top: 20px;">
                ...
                <div class="alas_luar">
                    ...
                    <?php foreach( $mbank as $row2 ) : ?>
                        <option value="<?= $row2['no'] ?>" <?php if($mcoa['mbnk']==$row2['no']) echo 'selected="selected"'; ?>><?= $row2['nama'] ?></option>
                    <?php endforeach ?>
                    </select>
                </div>
            </div>
            <div style="margin-top: 20px;">
                ...
                <div class="alas_luar">
                    <input type="text" name="kode" value="<?= $mcoa['kode']; ?>" class="form_input" maxlength="16" required>
                </div>
            </div>
            <div style="margin-top: 20px;">
                <label>Nama<span class="required">*</span></label>
                <div class="alas_luar">
                    <input type="text" name="nama" value="<?= $mcoa['nama']; ?>" class="form_input" maxlength="64" required autofocus>
                </div>
            </div>
            <div style="margin-top: 20px;">
                <label>Level<span class="required">*</span></label>
                <div class="alas_luar">
                    <input type="text" name="lvl" class="form_input" value="<?= $mcoa['lvl']; ?>" maxlength="2" minlength="1" id="Level" required>
                </div>
            </div>
            <div style="margin-top: 20px;">
                <label>Keterangan</label>
                <div class="alas_luar">
                    <textarea class="form_input" rows="3" id="Keterangan" name="ket"><?= $mcoa['ket']; ?></textarea>
                </div>
            </div>
