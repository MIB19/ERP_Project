<div class="form_erp">
	<div class="form_erp_top">Edit Gudang</div>
	<div style="float:left;">
		<a onclick="balik('4')" style="color:white;text-decoration: none;">
    ...
    <div class="container">
        <form action="<?php echo $config->base_url();?>updatemgdn.html" class="" method="post">
            <input type="hidden" name="no" value="<?= $mgdn['no']; ?>" required>
            ...
            <div style="margin-top: 10px;">
                ...
                <div class="alas_luar">
                    ...
                    <?php foreach( $prsh as $row1 ) : ?> 
                        <option value="<?= $row1['no'] ?>" <?php if($mgdn['mprsh']==$row1['no']) echo 'selected="selected"'; ?>><?= $row1['nama'] ?></option>
                    <?php endforeach ?>
                    </select>
                </div>
            </div>
            <div style="margin-top: 10px;">
                ...
                <div class="alas_luar">
                    ...
                    <?php foreach( $mcab as $row ) : ?> 
                        <option value="<?= $row['no'] ?>" <?php if($mgdn['mcab']==$row['no']) echo 'selected="selected"'; ?>><?= $row['nama'] ?></option>
                    <?php endforeach ?>
                    </select>
                </div>
            </div>
            <div style="margin-top: 10px;">
                <label>Nama Gudang<span class="required">*</span></label>
                <div class="alas_luar">
                    <input type="text" name="nama" value="<?= $mgdn['nama']; ?>" class="form_input" required autofocus>
                </div>
            </div>
            <div style="margin-top: 10px;">
                <label>Keterangan<span class="required">*</span></label>
                <div class="alas_luar">
                    <textarea class="form_input" rows="3" name="ket"><?= $mgdn['ket']; ?></textarea>
                </div>
            </div>
