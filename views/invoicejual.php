		...
		<table id="myTable" style="font-size:13px;width:1500px;">
			<thead>
				<tr onClick=""  class="border_black">
                    ...
                    <th style="width: 7%;">Tanggal Jatuh Tempo</th>
...
$(document).ready(function(){
	...
	function detail(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>tijd/'+param+'.html',function(data){
			$('#tester').html(data);
		});
	}
	...
	function add(){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>addtijh.html',function(data){
			$('#tester').html(data);
		});
	}
    </script>