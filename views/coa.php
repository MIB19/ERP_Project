...
$(document).ready(function(){
	...
	function add(){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>addcoa.html',function(data){
			$('#tester').html(data);
		});
	}
	function update(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>selectmcoa/'+param+'.html',function(data){
			$('#tester').html(data);
		});
	}
	function aktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>aktifmcoa/'+param+'.html',function(data){
	...
	function nonaktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>nonaktifmcoa/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>coa.html',function(data){
				$('#tester').html(data);
			});
		});
	...
	function action_delete(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>hapusmcoa/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>coa.html',function(data){
				$('#tester').html(data);
			});
		});
