<div class="form_erp">
	<div class="form_erp_top">Tambah Merk</div>
    ...
    <div class="container">
        <form action="<?php echo $config->base_url();?>insertmmrk.html" class="" method="post">
            <input type="hidden" name="kode" value="<?= $kdmrk; ?>" required>
            ...
            <div style="margin-top: 10px;">
                ...
                <div class="alas_luar">
                    <input type="text" name="kodegl" class="form_input" maxlength="16" autofocus>
                </div>
            </div>
            <div style="margin-top: 10px;">
                <label>Nama</label>
            ...
            <div style="margin-top: 10px;">
                ...
                <div class="alas_luar">
                    <textarea  rows="3" class="form_input" id="Keterangan" name="ket"></textarea>
                </div>
            </div>
            <div style="margin-top:10px">
