<div class="form_erp">
	<div class="form_erp_top">Tambah Aset</div>
    ...
    <div class="container">
        <form action="<?php echo $config->base_url();?>insertmaset.html" class="" method="post">
            <input type="hidden" name="kode" value="<?= $kdaset; ?>" required>
            ...
            <div style="margin-top: 20px;">
                ...
                <div class="alas_luar">
                    <input type="text" name="noseri" class="form_input" maxlength="40" required>
                </div>
            </div>
            <div style="margin-top: 20px;">
            ...
            <div style="margin-top: 20px;">
                ...
                <div class="alas_luar">
                    <input type="number" name="qty" class="form_input" maxlength="11" required>
                </div>
            </div>
            <div style="margin-top: 20px;">
