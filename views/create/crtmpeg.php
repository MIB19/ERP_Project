<div class="form_erp">
    ...
    <div class="container">
        <form action="<?php echo $config->base_url();?>insertmpeg.html" class="" method="post">
            <input type="hidden" name="kode" value="<?= $kdmpeg; ?>" required>
            ...
            <div style="margin-top: 20px;">
                ...
                <div class="alas_luar">
                    <textarea class="form_input" rows="3" id="Alamat" name="alm"></textarea>
                </div>
            </div>
            <div style="margin-top: 20px;">
            ...
            <div style="margin-top: 20px;">
                ...
                <div class="alas_luar">
                    <input type="number" name="hp" class="form_input" maxlength="14" required>
                </div>
            </div>
            <div style="margin-top: 20px;">
            ...
            <div style="margin-top: 20px;">
                ...
                <div class="alas_luar">
                    <input type="text" name="fb" class="form_input" maxlength="96" required>
                </div>
            </div>
            <div style="margin-top: 20px;">
            ...
            <div style="margin-top: 20px;">
                ...
                <div class="alas_luar">
                    <input type="text" name="bnkcab" class="form_input" maxlength="60" required>
                </div>
            </div>
            <div style="margin-top: 20px;">
            ...
            <div style="margin-top: 20px;">
                ...
                <div class="alas_luar">
                    <input type="text" name="pkpno" class="form_input" maxlength="20" required>
                </div>
            </div>
            <div style="margin-top: 20px;">
                <label>Nama PKP<span class="required">*</span></label>
                <div class="alas_luar">
                    <input type="text" name="pkpnm" class="form_input" maxlength="60" required>
                </div>
            </div>
            <div style="margin-top: 20px;">
            ...
            <div style="margin-top: 20px;">
                ...
                <div class="alas_luar">
                    <input type="date" name="tgllahir" class="form_input" maxlength="40" required>
                </div>
            </div>
            <div style="margin-top: 20px;">
                <label>Tgl Join<span class="required">*</span></label>
                <div class="alas_luar">
                    <input type="date" name="tgljoin" class="form_input" maxlength="40" required>
                </div>
            </div>
            <div style="margin-top: 20px;">
