<div class="form_erp">
	...
	<div style="float:left;">
		<a onclick="balik('2')" style="color:white;text-decoration: none;">
    ...
    <div class="container">
        <form action="<?php echo $config->base_url();?>insertmcab.html" class="" method="POST">
            ...
            <div style="margin-top:10px">
				...
				<div class="alas_luar">
					<input type="text" name="nama" class="form_input" id="Nama" minlength="1" required autofocus>
				</div>
			</div>
			<div style="margin-top:10px">
			...
			<div style="margin-top:10px">
				...
				<div class="alas_luar">
					<input type="number" name="notelp" class="form_input" id="Notelp" maxlength="13" required>
				</div>
			</div>
            <div style="margin-top:10px">
			...
			<div style="margin-top:10px">
				...
				<div class="alas_luar">
					<input type="number" name="nohp" class="form_input" id="Nohp" maxlength="13" required>
				</div>
			</div>
			<div style="margin-top:10px">
