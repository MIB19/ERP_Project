<div class="form_erp">
    ...
    <div class="container">
        ...
        <form action="<?php echo $config->base_url();?>inserttsjh.html" class="" method="post">
            ...
            <div style="margin-top: 20px;">
                ...
                <div class="alas_luar">
                    <input type="text" name="kodegl" id="kodegl" class="form_input">
                </div>
            </div>
            <div style="margin-top: 20px;">
            ...
            <div style="margin-top: 20px;">
                ...
                <div class="alas_luar">
                    <input type="date" name="tglkrm" class="form_input" id="tglkrm" required>
                </div>
            </div>
            <!-- <div style="margin-top: 20px;">
