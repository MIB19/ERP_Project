<div class="form_erp">
	<div class="form_erp_top">Tambah Kategori 2</div>
    ...
    <div class="container">
        <form action="<?php echo $config->base_url();?>insertmkat2.html" class="" method="post">
            <input type="hidden" name="kode" value="<?= $kdkat2; ?>" required>
