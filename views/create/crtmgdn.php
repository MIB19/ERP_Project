<div class="form_erp">
	<div class="form_erp_top">Tambah Gudang</div>
    ...
    <div class="container">
        <form action="<?php echo $config->base_url();?>insertmgdn.html" class="" method="post">
            <input type="hidden" name="kode" value="<?= $kdmgdn; ?>" required>
            ...
            <div style="margin-top: 10px;">
                ...
                <div class="alas_luar">
                    <input type="text" name="nama" class="form_input" required autofocus>
                </div>
            </div>
            <div style="margin-top: 10px;">
