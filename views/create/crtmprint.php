<div class="form_erp">
	<div class="form_erp_top">Tambah Printer</div>
    ...
    <div class="container">
        <form action="<?php echo $config->base_url();?>insertmprint.html" class="" method="POST">
            <input type="hidden" name="kode" value="<?= $kdprnt; ?>" required>
			...
			<div style="margin-top:10px">
				...
				<div class="alas_luar">
					<input type="text" name="gip" class="form_input" required>
				</div>
			</div>
			<div style="margin-top:10px">
