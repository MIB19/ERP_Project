<div class="form_erp">
	<div class="form_erp_top">Tambah Kategori 3</div>
    ...
    <div class="container">
        <form action="<?php echo $config->base_url();?>insertmkat3.html" class="" method="post">
            <input type="hidden" name="kode" value="<?= $kdkat3; ?>" required>
