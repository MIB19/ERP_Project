<div class="form_erp">
	<div class="form_erp_top">Tambah Satuan</div>
    ...
    <div class="container">
        <form action="<?php echo $config->base_url();?>insertmsat.html" class="" method="POST">
            <input type="hidden" name="kode" value="<?= $kdsat; ?>" required>
