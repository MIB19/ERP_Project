<div class="form_erp">
	<div class="form_erp_top">Tambah Kategori 1</div>
    ...
    <div class="container">
        <form action="<?php echo $config->base_url();?>insertmkat1.html" class="" method="post">
            <input type="hidden" name="kode" value="<?= $kdkat1; ?>" required>
