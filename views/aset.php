...
$(document).ready(function(){
	...
	function add(){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>addaset.html',function(data){
			$('#tester').html(data);
		});
	}
	function update(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>selectmaset/'+param+'.html',function(data){
			$('#tester').html(data);
		});
	}
	function aktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>aktifmaset/'+param+'.html',function(data){
	...
	function nonaktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>nonaktifmaset/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>aset.html',function(data){
				$('#tester').html(data);
			});
		});
	...
	function action_delete(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>hapusmaset/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>aset.html',function(data){
				$('#tester').html(data);
			});
		});
