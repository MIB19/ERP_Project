...
$(document).ready(function(){
	...
	function update(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>selectmprint/'+param+'.html',function(data){
			$('#tester').html(data);
		});
	}
	function aktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>aktifmprint/'+param+'.html',function(data){
	...
	function nonaktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>nonaktifmprint/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>mprint.html',function(data){
				$('#tester').html(data);
			});
		});
	...
	function action_delete(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>hapusmprint/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>mprint.html',function(data){
				$('#tester').html(data);
			});
		});
	...
	function add(){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>addmprint.html',function(data){
			$('#tester').html(data);
		});
	}
    </script>