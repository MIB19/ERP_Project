...
$(document).ready(function(){
	...
	function update(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>selectmmrk/'+param+'.html',function(data){
			$('#tester').html(data);
		});
	}
	function aktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>aktifmmrk/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>mbrg/3.html',function(data){
				$('#tester').html(data);
			});
		});
	}
	function nonaktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>nonaktifmmrk/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>mbrg/3.html',function(data){
				$('#tester').html(data);
			});
		});
	...
	function action_delete(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>hapusmmrk/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>mbrg/3.html',function(data){
				$('#tester').html(data);
			});
		});
