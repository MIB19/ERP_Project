		...
		<table id="myTable" style="font-size:13px;width:1500px;">
			<thead>
				<tr onClick=""  class="border_black">
					...
					<th style="width: 5%;">Kode Invoice</th>
                    <th style="width: 6%;">Gudang</th>
                    <th style="width: 8%;">Supplier</th>
                    <th style="width: 8%;">Supplier CP</th>
                    <th style="width: 10%;">Sales</th>
                    <th style="width: 5%;">Tanggal</th>
                    <th style="width: 6%;">Jenis Pembayaran</th>
                    <th style="width: 6%;">Termin</th>
                    <th style="width: 6%;">Tanggal Jatuh Tempo</th>
                    <th style="width: 6%;">No Faktur</th>
                    <th style="width: 6%;">Tgl Faktur</th>
...
$(document).ready(function(){
	...
	function detail(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>tibd/'+param+'.html',function(data){
			$('#tester').html(data);
		});
	}
	...
	function add(){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>addtibh.html',function(data){
			$('#tester').html(data);
		});
	}
    </script>