...
$(document).ready(function(){
	...
	function update(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>selectmsat/'+param+'.html',function(data){
			$('#tester').html(data);
		});
	}
	function aktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>aktifmsat/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>mbrg/2.html',function(data){
				$('#tester').html(data);
			});
		});
	}
	function nonaktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>nonaktifmsat/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>mbrg/2.html',function(data){
				$('#tester').html(data);
			});
		});
	...
	function action_delete(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>hapusmsat/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>mbrg/2.html',function(data){
				$('#tester').html(data);
			});
		});
