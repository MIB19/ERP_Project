		...
		<table id="myTable" style="font-size:13px;width:1500px;">
			<thead>
				<tr onClick=""  class="border_black">
                    ...
                    <th style="width: 8%;">Customer CP</th>
                    <th style="width: 6%;">Customer PO</th>
                    <th style="width: 7%;">Ekspedisi</th>
                    <th style="width: 7%;">Sales</th>
                    <th style="width: 7%;">Tanggal</th>
                    <th style="width: 6%;">Jenis Pembayaran</th>
                    <th style="width: 6%;">Jenis PPN</th>
...
$(document).ready(function(){
	...
	function detail(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>tsjd/'+param+'.html',function(data){
			$('#tester').html(data);
		});
	}
	...
	function add(){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>addtsjh.html',function(data){
			$('#tester').html(data);
		});
	}
    </script>