...
$(document).ready(function(){
	...
	function update(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>selectmgdn/'+param+'.html',function(data){
			$('#tester').html(data);
		});
	}
	function aktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>aktifmgdn/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>prsh/4.html',function(data){
				$('#tester').html(data);
			});
		});
	}
	function nonaktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>nonaktifmgdn/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>prsh/4.html',function(data){
				$('#tester').html(data);
			});
		});
	...
	function action_delete(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>hapusmgdn/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>prsh/4.html',function(data){
				$('#tester').html(data);
			});
		});
