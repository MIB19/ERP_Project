...
$(document).ready(function(){
	...
	function update(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>selectmbank/'+param+'.html',function(data){
			$('#tester').html(data);
		});
	}
	function aktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>aktifmbank/'+param+'.html',function(data){
	...
	function nonaktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>nonaktifmbank/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>bank.html',function(data){
				$('#tester').html(data);
			});
		});
	...
	function action_delete(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>hapusmbank/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>bank.html',function(data){
				$('#tester').html(data);
			});
		});
	...
	function add(){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>addbank.html',function(data){
			$('#tester').html(data);
		});
	}
    </script>