...
$(document).ready(function(){
	...
	function update(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>selectmeks/'+param+'.html',function(data){
			$('#tester').html(data);
		});
	}
	function aktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>aktifmeks/'+param+'.html',function(data){
	...
	function nonaktif(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>nonaktifmeks/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>meks.html',function(data){
				$('#tester').html(data);
			});
		});
	...
	function action_delete(param){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>hapusmeks/'+param+'.html',function(data){
			$.post('<?php echo $config->base_url();?>meks.html',function(data){
				$('#tester').html(data);
			});
		});
	...
	function add(){
		$('#tester').html('Loading...');
		$.post('<?php echo $config->base_url();?>addmeks.html',function(data){
			$('#tester').html(data);
		});
	}
    </script>